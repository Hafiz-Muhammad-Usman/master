         ...
         <div class="main_container">
            <div class="col-md-3 left_col">
               <div class="left_col scroll-view">
                  <div class="navbar nav_title" style="border: 0;">
                     <a href="#" class="site_title"><i class="fa fa-paw"></i> <span>{{@config('constants.site_name')}}</span></a>
                  </div>
            ...
            <footer>
               <div class="pull-right">
                  Gentelella - Bootstrap Admin Template by <a href="https://colorlib.com">Website Creater</a>
               </div>
               <div class="clearfix"></div>
            </footer>
            <!-- /footer content -->
